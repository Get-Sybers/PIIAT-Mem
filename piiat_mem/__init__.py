...
Volatility 3, including the custom DFIR plugins (windows.piiat.processes,
windows.piiat.registry) and the flat jsonl_dfir renderer. Runs the analysis inside a minimal hardened
