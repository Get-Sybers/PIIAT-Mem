...
Volatility 3, including the custom DFIR plugins (dfir_processes, dfir_registry)
and the flat jsonl_dfir renderer. Runs the analysis inside a minimal hardened
